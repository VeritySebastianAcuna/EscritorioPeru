...
//		DesiredCapabilities caps = new DesiredCapabilities();
	...
	@Test
	public void Script_0055() throws InterruptedException, IOException, InvalidFormatException {
//		EAP_0055
		String cp = "EAP_0055";
		System.out.println(cp);
		System.out.println("validar que se suba el cambio");
		...
		pageSeleccionCpe.seleccionTipoAfectaGratuita(datos[5], cp);
